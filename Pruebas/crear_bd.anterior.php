...
//									TABLA DE ALUMNOS
 ...
 $sql = "CREATE TABLE IF NOT EXISTS `alumnos` (
  ...
  KEY `al_codgru` (`al_codgru`),
  KEY `al_cuenta` (`al_cuenta`)
) ENGINE=MyISAM AUTO_INCREMENT=10234 " .
  "DEFAULT CHARSET = utf8;";
 if (!mysqli_query($con, $sql)) {
...
//									TABLA DE PARTES
 ...
 $sql = "CREATE TABLE partes (pa_id     INT(11) AUTO_INCREMENT, " .
			     "pa_codalu INT(11) NOT NULL, " .
                             ...
                             "pa_codpro VARCHAR(9) DEFAULT NULL, " .
                             "PRIMARY KEY (pa_id), " .
...
//									TABLA DE MENUS
 ...
 $sql = "CREATE TABLE menus (me_codigo int(4) NOT NULL, " .
                            "me_idpadre  int(4) NOT NULL, " .
                            "me_texto_es  VARCHAR(50) NOT NULL, " .
                            "me_texto_en  VARCHAR(50) NOT NULL, " .
                            "me_codrol TINYINT(2) NOT NULL, " .
                            "me_descri VARCHAR(50), " .
 ...
 $sql = "INSERT INTO menus (me_codigo, me_idpadre, me_texto_es, me_texto_en, me_codrol, me_descri, me_enlace_es, me_enlace_en,
                            me_target) VALUES
(1,  0,'INICIO',        'HOME',     0, 'Home del sitio Web', 'index.php', 'index_en.php', '_self'),
  (11, 1,'Inicio',     'Home', 0, 'Página HOME', 'index.php', 'index_en.php', '_self'),
  (12, 1,'Contactar',  'Contact', 0, 'Información de contacto', 'index.php?inicon', 'index_en.php?inicon', '_self'),
  (13, 1,'Enseñanzas', 'Teachings', 0, 'Información de enseñanzas', 'index.php?iniens', 'index_en.php?iniens', '_self'),
  (14, 1,'Secretaría', 'Secretary\'s Office', 0, 'Información de secretaría', 'index.php?inisec', 'index_en.php?inisec', '_self'),
(2,  0,'DIRECCIÓN',     'HEADSHIP', 0, 'Publicaciones de la dirección', 'index.php?dirini', 'index_en.php?dirini', '_self'),
  (21, 2,'Inicio',          'Start', 0, 'Inicio de Dirección', 'index.php?dirini', 'index_en.php?dirini', '_self'),
  (22, 2,'Equipo Directivo','Leadership Team', 0, 'Información de dirección', 'index.php?direqu', 'index_en.php?direqu', '_self'),
  (23, 2,'Consejo Escolar', 'School Council', 0, 'Consejo escolar', 'index.php?dircon', 'index_en.php?dircon', '_self'),
(3,  0,'JEFATURA',      'HEAD OF STUDIES', 0, 'Publicaciones de Jefatura', 'index.php?jefini', 'index_en.php?jefini', '_self'),
  (31, 3,'Inicio',    'Start', 0, 'Inicio de Jefatura', 'index.php?jefini', 'index_en.php?jefini', '_self'),
  (32, 3,'Documentos','Documents', 30, 'Consulta y descarga de documentos', 'index.php?jefdoc', 'index_en.php?jefdoc', '_self'),
  (33, 3,'Programaciones','Programations', 30, 'Seguimiento de programas', 'index.php?jefpro', 'index_en.php?jefpro', '_self'),
  (34, 3,'Actas',         'Actas', 30, 'Gestión de actas', 'index.php?jefact', 'index_en.php?jefact', '_self'),
     (341, 34,'Subir actas',  'Subir actas', 60, 'Subir actas', 'index.php?jefactsub', 'index_en.php?jefactsub', '_self'),
     (342, 34,'Consultar actas','Consultar actas', 30, 'Información de actas', 'index.php?jefactcon', 'index_en.php?jefactcon', '_self'),
  (35, 3,'Partes',        'Sanctions', 65, 'Gestión de partes', 'index.php?jefpar', 'index_en.php?jefpar', '_self'),
(4,  0,'ADMINISTRACIÓN','ADMINISTR.', 0, 'Publicaciones de administración', 'index.php?admini', 'index_en.php?admini', '_self'),
  (41, 4,'Inicio',        'Start', 0, 'Inicio de Administración', 'index.php?admini', 'index_en.php?admini', '_self'),
  (42, 4,'Saldos',        'Balance', 30, 'Información de saldos', 'index.php?admsal', 'index_en.php?admsal', '_self'),
  (43, 4,'Movimientos',   'Movements', 30, 'Información de movimientos', 'index.php?admmov', 'index_en.php?admmov', '_self'),
  (44, 4,'Dietas',        'Allowances', 0, 'Información de dietas', 'index.php?admdie', 'index_en.php?admdie', '_self'),
(5,  0,'DEPARTAMENTOS', 'DEPARTMENTS', 0, 'Publicaciones de los departamentos', 'index.php?dep', 'index_en.php?dep', '_self'),
(6,  0,'ALUMNOS',       'STUDENTS', 0, 'Publicaciones de los alumnos', 'index.php?aluini', 'index_en.php?aluini', '_self'),
  (61, 6,'Inicio',        'Start', 0, 'Inicio de Alumnos', 'index.php?aluini', 'index_en.php?aluini', '_self'),
(7, 0,'MULTIMEDIA',     'MULTIMEDIA', 0, 'Galerías multimedia', 'index.php', 'index_en.php', '_self'),
  (71, 7, 'Imágenes',    'Images', 0, 'Ver galerías de imágenes', 'index.php?multimg', 'index_en.php?multimg', '_self'),
  (72, 7, 'Vídeos',      'Videos', 0, 'Ver galerías de vídeos', 'index.php?multivid', 'index_en.php?multivid', '_self'),
  (73, 7, 'Gestión',     'Gestion', 30, 'Gestión de multimedia', '', '', '_self'),
  (731, 73, 'Gestión Imágenes', 'Gestión Imágenes', 30, 'Gestión de Galerías de Imágenes', 'index.php?multigesimg', 'index_en.php?multigesimg', '_self'),
  (732, 73, 'Gestión Vídeos', 'Gestión Vídeos', 30, 'Gestión de Galerías Vídeos', 'index.php?multigesvid', 'index_en.php?multigesvid', '_self'),
(8,  0,'AMPA',          'AMPA', 0, 'Publicaciones del AMPA', 'index.php?ampini', 'index_en.php?ampini', '_self'),
  (81, 8,'Inicio',        'Start', 0, 'Información del AMPA', 'index.php?ampini', 'index_en.php?ampini', '_self'),
(9,  0,'TIC',           'TIC', 0, 'Operaciones relacionadas con las TIC', 'index.php?ticini', 'index_en.php?ticini', '_self'),
  (91, 9,'Inicio',        'Start', 0, 'Información de TIC', 'index.php?ticini', 'index_en.php?ticini', '_self'),
  (92, 9,'Recursos',      'Recursos', 0, 'Administración de recursos', 'index.php?ticrec', 'index_en.php?ticrec', '_self'),
  (93, 9,'Tablas',        'Tablas', 68, 'Administraciónd de la BBDD', 'phpmyadmin', 'phpmyadmin', '_blank');";

 if (!mysqli_query($con, $sql)) {
    die ('No se pueden dar de alta las opciones del menu:' .
          mysqli_error($con));
 };
 echo "Se han dado de alta las opciones del menú<br>";
//									TABLA DE SOCIOS
 echo "Procedo a crear la tabla socios<br>";

$sql = "CREATE TABLE socios (so_dni    varchar(9) NOT NULL, ".
                            "so_nombre varchar(30) NOT NULL, ".
                            "so_apell1 varchar(30) NOT NULL, ".
                            "so_apell2 varchar(30) NOT NULL, ". 
                            "so_direcc varchar(50) DEFAULT NULL, ".
                            "so_codpos varchar(5)  DEFAULT NULL, ".
                            "so_poblac varchar(50) DEFAULT NULL, ".
                            "so_provin varchar(30) DEFAULT NULL, ".
                            "so_email  varchar(50) DEFAULT NULL, ".
                            "so_telef1 varchar(12) DEFAULT NULL, ".
                            "so_telef2 varchar(12) DEFAULT NULL, ".
                            "so_fecha  varchar(4)  NOT NULL, ".
                       "PRIMARY KEY (so_dni)) ".
                       "ENGINE = MYISAM " .
                       "DEFAULT CHARSET = utf8;";

 if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla socios:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de socios<br>";

 $sql = "INSERT INTO socios (so_dni,    so_nombre, so_apell1, so_apell2, so_direcc, so_codpos, 
                            so_poblac, so_provin, so_email,  so_telef1, so_telef2, so_fecha) VALUES
   ('00000000', 'SOCIO', 'DE PRUEBA', 'DE INICIO', 'Avda. Andalucía Km. 6,200', '28041',
    'Madrid', 'MADRID', 'socio@tiernogalvan.es', '910000000', '666666666', '2013');";

 if (!mysqli_query($con, $sql)) {
    die ('No se puede dar de alta el primer socio:' .
          mysqli_error($con));
 };
 echo "Se ha dado de alta el primer socio<br>";

//									TABLA DE CUOTAS DE SOCIOS DEL AMPA
 echo "Procedo a crear la tabla cuotas_socios<br>";

 $sql = "CREATE TABLE cuotas_socios (cs_codigo        int(5)       NOT NULL AUTO_INCREMENT, ".
                                    "cs_dni           varchar(9)   NOT NULL, ".
                                    "cs_anio_cuota    varchar(4)   NOT NULL, ".
                                    "cs_fecha_emision date         NOT NULL, ".
                                    "cs_importe       decimal(6,2) NOT NULL, ".
                            "PRIMARY KEY (cs_codigo), ".
                            "FOREIGN KEY (cs_dni) REFERENCES socio(so_dni))" .
                            "ENGINE = MYISAM " .
                            "DEFAULT CHARSET = utf8;";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla cuotas_socios:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de cuotas de socios del ampa<br>";

 $sql = "INSERT INTO cuotas_socios (cs_dni, cs_anio_cuota, cs_fecha_emision, cs_importe) VALUES
   ('00000000', '2012', '1988-10-16', 100.00);";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede dar de alta una cuota:' .
          mysqli_error($con));
 };
 echo "Se ha dado de alta una cuota<br>";
...
if (!mysqli_query($con, $sql)) {
 ...
 //									TABLA DE ARCHIVOS
 echo "Procedo a crear la tabla de archivos<br>";
 
 $sql = "CREATE TABLE `archivos` (`id_archivos` int(11) NOT NULL AUTO_INCREMENT, ".
...
if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla de archivos:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de archivos<br>";
 
  //									TABLA DE CATEGORIAS
 echo "Procedo a crear la tabla de categorias<br>";
 
 $sql = "CREATE TABLE `categorias` (`cat_id_cat` int(3) NOT NULL AUTO_INCREMENT, ".
  "`tipo_cat` varchar(11) DEFAULT '1', ".
  "`nivel_cat` int(11) DEFAULT '1', ".
  "`parent_id_cat` int(10) DEFAULT '0', ".
  "`name_cat` varchar(255) DEFAULT '', ".
  "`desc_cat` text, ".
  ...
  "`usu_cat` varchar(255) DEFAULT NULL, ".
  "`usu_edit_cat` varchar(255) DEFAULT NULL, ".
...
if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla de categorias:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de categorias<br>";
 
   //									TABLA DE EDITOR
 echo "Procedo a crear la tabla de editor<br>";
 
 $sql = "CREATE TABLE `editor` (`id` int(5) NOT NULL AUTO_INCREMENT, ".
...
if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla de editor:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de editor<br>";
...
//                   				TABLA DE RESERVAS_TIC
 ...
 $sql = "INSERT INTO reservas_tic (rt_recur, rt_fecha, rt_turno, rt_hora, rt_codpro) VALUES
                                 ('AULACAF', '2013-06-29', 'M', '3', 'IF003');";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede dar de alta la reserva:' .
          mysqli_error($con));
 };
 echo "Se ha dado de alta la reserva del recurso"."<br>";
 //                   				TABLA DE RESERVAS_HORARIO
  echo "Procedo a crear la tabla del horario de las reservas<br>";
 $sql = "CREATE TABLE reservas_horario (hor_num_hora varchar(1) NOT NULL, " .
				       "hor_turno varchar(1) NOT NULL, " .
				       "hor_texto varchar(20) NOT NULL, " .
				       "hor_desc_horario varchar(20) NOT NULL, " .
				       "PRIMARY KEY (hor_num_hora,hor_turno)" .
				       ") ENGINE = MYISAM " .
                                       "DEFAULT CHARSET = utf8;";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla de reservas:' .
 ...
 $sql = "INSERT INTO reservas_horario (hor_num_hora, hor_turno, hor_texto, hor_desc_horario) VALUES
...
//                   				TABLA AUXILIAR
  echo "Procedo a crear la tabla de auxiliar<br>";
 $sql = "CREATE TABLE auxiliar (au_id tinyint(1) AUTO_INCREMENT, " .
                               "au_coddep varchar(5), " .
                               "au_codpro varchar(9), " .
                               "au_codasi varchar(5), " .
                               "au_codgru varchar(5), " .
                               ...
                               "DEFAULT CHARSET = utf8;";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla de auxiliar:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla de auxiliar<br>";

$sql = "INSERT INTO auxiliar (au_id, au_coddep, au_codpro, au_codasi, au_codgru) VALUES (1, NULL, NULL, NULL, NULL)";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede dar de alta el contenido auxiliar:' .
          mysqli_error($con));
 };
 echo "Se ha dado de alta el contenido auxiliar correctamente"."<br>";
 ...
 $sql = "INSERT INTO ofertas (of_codigo, of_nombreEmpresa, of_ubicacion, of_telefono, of_email, of_puestoOfertado, of_descripcion, of_jornada, of_requisitos, of_puestosVacantes, of_fecha) VALUES
                                ('0F001', 'Guapu Tecnologies', 'Avd. de Orovilla Nº54', '94123658952', 'email@gmail.com', 'Programador', 'Empresa busca programador', 'Completa', 'Conocimientos de programación', '1', '20/06/2013');";
 if (!mysqli_query($con, $sql)) {
 ...
 $sql = "INSERT INTO ofertas (of_codigo, of_nombreEmpresa, of_ubicacion, of_telefono, of_email, of_puestoOfertado, of_descripcion, of_jornada, of_requisitos, of_puestosVacantes, of_fecha) VALUES
                                ('0F002', 'Guapi Tecnologies', 'Avd. de Oro Nº55', '94123658952', 'email2@gmail.com', 'Programadores', 'Empresa busca programadores', 'Media', 'Conocimientos de programación, etc..', '2', '22/06/2013');";
 if (!mysqli_query($con, $sql)) {
 ...
 echo "Procedo a crear la tabla de suscripcion<br>";
 $sql = "CREATE TABLE suscripcion (su_email VARCHAR(240)  NOT NULL, " .
                                 "PRIMARY KEY (su_email) " .
                                 ") ENGINE = MYISAM " .
                                 "DEFAULT CHARSET = utf8;";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede crear la tabla suscripcion:' .
          mysqli_error($con));
 };
 echo "Se ha creado la tabla suscripcion<br>";
 $sql = "INSERT INTO suscripcion (su_email) VALUES
                                ('ricardo.ch.92@hotmail.com')";
 if (!mysqli_query($con, $sql)) {
    die ('No se puede dar de alta la suscripcion 0S001:' .
          mysqli_error($con));
 };
